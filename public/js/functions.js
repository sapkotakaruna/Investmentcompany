		...
		return {
			...
			onLoad: () => {
				...
				btn.addEventListener("click", function(){
					const trigger= document.getElementById("triggerMenu");
					const menu = document.getElementById("primary_menu");
					if(!trigger.classList.contains("primary-menu-trigger-active")){
				  ...
				  $(document).ready(function () {
					$('a[data-toggle="tab"]').on('click', function (e) {
						...
						// Add active class to clicked nav-link and associated content section
