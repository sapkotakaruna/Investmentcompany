...
use App\Http\Requests\Admin\Career\StoreCareerValidation;
use App\Http\Requests\Admin\Career\UpdateCareerValidation;
...
class CareerController extends BaseController
{
    ...
    public function __construct(CrudInterface $crud, Career $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreCareerValidation $request)
    {
    ...
    public function edit($id)
    {
        ...
        return view(parent::loadCommonDataToView($this->view_path . '.edit'));
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateCareerValidation $request, $id)
    {
