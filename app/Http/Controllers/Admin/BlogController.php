...
use App\Http\Requests\Admin\Blog\StoreBlogValidation;
use App\Http\Requests\Admin\Blog\UpdateBlogValidation;
use App\Models\Blog;
...
class BlogController extends BaseController
{
    ...
    public function __construct(CrudInterface $crud, Blog $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
