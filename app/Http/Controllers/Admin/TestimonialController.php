...
use App\Http\Requests\Admin\Testimonial\StoreTestimonialValidation;
use App\Http\Requests\Admin\Testimonial\UpdateTestimonialValidation;
...
class TestimonialController extends BaseController
{
    ...
    public function __construct(CrudInterface $crud, Testimonial $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreTestimonialValidation $request)
    {
        ...
        $request->session()->flash('success_message', $this->panel . ' ' . $data['name'] . ' added Successfully');
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateTestimonialValidation $request, $id)
    {
