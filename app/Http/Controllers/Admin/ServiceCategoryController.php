...
use App\Http\Requests\Admin\ServiceCategory\StoreServiceCategoryValidation;
use App\Http\Requests\Admin\ServiceCategory\UpdateServiceCategoryValidation;
...
{
    //properties
    protected $base_route = 'admin.serviceCategory';
    protected $view_path = 'admin.serviceCategory';
    protected $panel = 'ServiceCategory';
    protected $folder = 'serviceCategory';
    protected $folder_path;
    protected $crud;
    protected $service;


    public function __construct(CrudInterface $crud, ServiceCategory $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreServiceCategoryValidation $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateServiceCategoryValidation $request, $id)
    {
