...
use App\Http\Requests\Admin\MemberCategory\StoreMemberCategoryValidation;
...
class MemberCategoryController extends BaseController
{
    //properties
    protected $base_route = 'admin.memberCategory';
    protected $view_path = 'admin.memberCategory';
    protected $panel = 'MemberCategory';
    protected $folder = 'memberCategory';
    protected $folder_path;
    protected $crud;
    protected $service;


    public function __construct(CrudInterface $crud, MemberCategory $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
    ...
    {
        $data = [];
        $data['group'] = $this->model->whereNull('parent_id')->active()->pluck('title', 'id');
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StoreMemberCategoryValidation $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateMemberCategoryValidation $request, $id)
    {
