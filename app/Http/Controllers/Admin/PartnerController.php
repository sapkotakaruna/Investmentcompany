...
class PartnerController extends BaseController
{
    ...
    protected $panel = 'Partner';
    protected $folder = 'partner';
    protected $folder_path;
    protected $crud;
    protected $service;


    public function __construct(CrudInterface $crud, Partner $model, CrudService $service)
    {
        $this->model = $model;
        $this->crud = $crud;
     ...
     * @return \Illuminate\Http\Response
     */
    public function store(StorePartnerValidation $request)
    {
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdatePartnerValidation $request, $id)
    {
